...
(cl:defmethod cl:initialize-instance :after ((m <myservice-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'myservice-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dim-srv:<myservice-request> is deprecated: use dim-srv:myservice-request instead.")))

(cl:ensure-generic-function 'req-val :lambda-list '(m))
(cl:defmethod req-val ((m <myservice-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dim-srv:req-val is deprecated.  Use dim-srv:req instead.")
  (req m))
...
(cl:defmethod cl:initialize-instance :after ((m <myservice-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'myservice-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dim-srv:<myservice-response> is deprecated: use dim-srv:myservice-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <myservice-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dim-srv:res-val is deprecated.  Use dim-srv:res instead.")
  (res m))
